...
-- Initial revision
--
--Revision 4.1  91/07/27  14:36:43  alliot
...
--
--Revision 2.4  91/07/17  11:26:16  alliot
...
--modele formel.
--
--Revision 2.3  91/07/16  17:27:45  alliot
...
--
--Revision 2.2  91/07/16  12:39:07  alliot
...
PACKAGE registres IS
   -- Les registres de la machine autres que les sommets de pile:
   rbottom : num_res   := null_res;
   qcurr   : num_quest := null_quest;
   fcurr   : num_objet := null_objet;
   fenv    : num_env   := null_env;
   cregle  : numero_regle;
   cclause : num_clause := null_clause;

   --Sauvegarde et restoration des registres
   PROCEDURE sauveregistres (gen : IN genre_backtrack);
   FUNCTION restoreregistres RETURN genre_backtrack;
