...
-- Initial revision
--
--Revision 4.1  91/07/27  14:36:21  alliot
...
--
--Revision 2.4  91/07/17  11:25:39  alliot
...
--modele formel.
--
--Revision 2.3  91/07/16  17:27:19  alliot
...
--
--Revision 2.2  91/07/16  12:38:50  alliot
...
GENERIC
   ...
   taille : IN indice;
   TYPE hash_value IS (<>);
   WITH FUNCTION hash (x : IN objet) RETURN hash_value IS <>;
   WITH FUNCTION keep (x, y : IN objet) RETURN objet;
   WITH FUNCTION egal (x, y : IN objet) RETURN boolean;
   WITH PROCEDURE affiche (x : IN objet);
PACKAGE genhash IS
   FUNCTION ajouter (x : IN objet) RETURN indice;
