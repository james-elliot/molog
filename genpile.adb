...
-- Initial revision
--
--Revision 4.1  91/07/27  14:36:23  alliot
...
--
--Revision 2.4  91/07/17  11:25:40  alliot
...
--modele formel.
--
--Revision 2.3  91/07/16  17:27:22  alliot
...
--
--Revision 2.2  91/07/16  12:38:51  alliot
...
PACKAGE BODY genpile IS
   ...
   FUNCTION empiler (x : IN objet) RETURN indice IS
      new_pile : acces_pile;
      new_last : indice;
      new_size : indice;
   BEGIN
   ...
   FUNCTION reserver (n : IN positive) RETURN indice IS
      new_pile : acces_pile;
      new_last : indice;
      new_size : indice;
      first    : indice;
   ...
   BEGIN
      ...
      END IF;
      IF i = indice'FIRST THEN
         RAISE pile_vide;
      END IF;
      RETURN pil (i);
   END recuperer;

   FUNCTION depiler RETURN objet IS
   BEGIN
      IF top = indice'FIRST THEN
         RAISE pile_vide;
      END IF;
      top := top - 1;
      RETURN pil (top + 1);
