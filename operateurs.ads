...
-- Initial revision
--
--Revision 4.1  91/07/27  14:36:32  alliot
...
--
--Revision 2.4  91/07/17  11:25:48  alliot
...
--modele formel.
--
--Revision 2.3  91/07/16  17:27:32  alliot
...
--
--Revision 2.2  91/07/16  12:38:58  alliot
...
--   FUNCTION nb_operateurs RETURN natural;
--   FUNCTION premier_operateur RETURN numero_operateur;
--   FUNCTION dernier_operateur RETURN numero_operateur;
   null_operateur : CONSTANT numero_operateur := 0;
--   FUNCTION egal (num : IN numero_operateur;
--                  nom : IN string;
--                  nb  : IN nombre_arguments) RETURN boolean;
   FUNCTION is_operateur  (nom : IN string; 
                           nb  : IN nombre_arguments) RETURN numero_operateur;

   FUNCTION nom_operateur (num : IN numero_operateur) RETURN string;

   TYPE resultat_execution IS (reussi, echec, fin);

   plus_de_regle : CONSTANT numero_regle := 0;
   -- ATTENTION , conventionnelelemt num1 est l'operateur du fait et num2 
   --l'operateur de la question!!!
   FUNCTION premiereregle
       (num1, num2 : IN numero_operateur) RETURN numero_regle;
   FUNCTION reglesuivante (num : IN numero_regle) RETURN numero_regle;
   FUNCTION executeregle (num : IN numero_regle) RETURN resultat_execution;

   TYPE resultat_reecriture IS (ok, not_ok, fin_fin);
